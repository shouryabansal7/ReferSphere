...
public interface AppliedReferralRepository extends JpaRepository<AppliedReferral,Long> {
    ...
    @Query(value = "SELECT * FROM applications WHERE referral_id = :referral_id",nativeQuery = true)
    List<AppliedReferral> findAllAppliedPostsByPostId(@Param("referral_id") Long referral_id);
